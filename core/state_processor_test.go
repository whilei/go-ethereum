...
//		},
//	},
func makeExpectedRewardCasesForConfig(c *params.ClassicChainConfig, numUncles int, t *testing.T) []expectedRewardCase {
...
func TestAccumulateRewards1(t *testing.T) {
	configs := []*params.ClassicChainConfig{DefaultConfigMainnet.ChainConfig, DefaultConfigMorden.ChainConfig}
