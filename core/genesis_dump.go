...
// 	dump.Alloc = params.GenesisAlloc{}
// 	for address, acct := range stateAccounts {
// 		if common.IsHexAddress(address) {
// 			dump.Alloc[params.Hex(address)] = &params.GenesisAlloc{
...
// 				return nil, fmt.Errorf("malformed account %q key: %s", addr, err)
// 			}
// 			if err := value.Decode(v[:]); err != nil {
// 				return nil, fmt.Errorf("malformed account %q value: %s", addr, err)
// 			}
...
// 		GasLimit:   "0x47E7C4",
// 		Difficulty: "0x020000",
// 		Alloc:      *param.GenesisAlloc,{}
// 	}
//
// 	for _, a := range accounts {
// 		dump.Alloc[a.] = params.GenesisAccount{
...
// 	for address, acct := range stateAccounts {
// 		if common.IsHexAddress(address) {
// 			i, ok := new(big.Int).SetString(acct.Balance, 10)
// 			if !ok {
// 				return nil, fmt.Errorf("invalid account balance: %v", acct.Balance)
// 			}
// 			dump.Alloc[common.HexToAddress(address)] = params.GenesisAccount{
// 				Balance: i,
// 			}
// 		} else {
// 			return nil, fmt.Errorf("Invalid address in genesis state: %v", address)
